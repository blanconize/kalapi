<template>
	<header ref="navbar">
		<div class="relative bg-black lg:h-32 overflow-visible z-30">
			<div class="area">
					...
					<div class="flex justify-start lg:w-0 lg:flex-1 relative h-12">
						<nuxt-link to="/">
							...
							<div class="lg:absolute lg:-top-8 lg:left-0">
								<nuxt-img class="h-20 xs:h-32 w-auto lg:h-40 transition-all" src="logo.svg" />
							</div>
						</nuxt-link>
					</div>
					...
					>
						<div class="pt-5 pb-6 px-5">
							<div class="flex items-center justify-between">
								<div>
									<img class="h-20 xs:h-32 w-auto" src="logo.svg" alt="Kalapi" />
								</div>
								<div class="-mr-2">
									<button
										type="button"
